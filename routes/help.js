...
router.get('/', (req, res, next) => {
    const pokeWorldRoutes = {
        ...
        routes: [{userRoutes: ['get_all_users: / ', 'get_user_by_id: /:id', 'get_encounter_by_userId: /:userId/encounters', 'get_all_pokemon_by_userId: /:userId/pokemon', 'get_pokemon_by_userId: /:userId/pokemon/:pokemonId', 'get_pokemonMove_by_pokemon_with_userId: :userId/pokemon/:pokemonId/moves/:moveId', 'get_battles_by_userId: /:userId/battles', 'sign_up: /signup', 'create_encounter: /:userId/encounters', 'update_encounter: /:userId/encounters/:encounterId', 'login: /login', 'update_user_by_id: /:userId', 'update_pokemonMoves_by_userId: /:userId/pokemon/:pokemonId/moves', 'update_pokemon_by_userId: /:userId/pokemon/:pokemonId', 'delete_user_by_userId: /:userId', 'delete_pokemon_by_userId: /:userId/pokemon/:pokemonId']},
